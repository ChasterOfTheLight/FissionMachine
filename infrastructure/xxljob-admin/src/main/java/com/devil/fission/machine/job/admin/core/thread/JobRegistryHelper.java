package com.devil.fission.machine.job.admin.core.thread;
...
import com.devil.fission.machine.job.admin.core.model.XxlJobRegistry;
...
public class JobRegistryHelper {
    ...
    public ReturnT<String> registry(RegistryParam registryParam) {
        ...
        // valid
        if (!StringUtils.hasText(registryParam.getRegistryGroup()) || !StringUtils.hasText(
                registryParam.getRegistryKey()) || !StringUtils.hasText(registryParam.getRegistryValue())) {
    ...
    private void updateGroupRegistryInfo(){
        ...
        synchronized (lock){
            ...
            if (groupList!=null && !groupList.isEmpty()) {
                ...
                for (XxlJobGroup group: groupList) {
                    ...
                    //fresh group cache 
                    XxlJobGroupLocalCache.refreshCache(group);
                }
            }
        }
    }
