package com.tojoy.mall.job.admin.core.trigger;

import com.tojoy.mall.job.admin.core.cache.XxlJobGroupLocalCache;
...
import com.tojoy.mall.job.admin.core.model.XxlJobLog;
import com.tojoy.mall.job.admin.core.route.ExecutorRouteStrategyEnum;
import com.tojoy.mall.job.admin.core.scheduler.XxlJobScheduler;
...
public class XxlJobTrigger {
    ...
    public static void trigger(int jobId, TriggerTypeEnum triggerType, int failRetryCount, String executorShardingParam,
        ...
        //use local cache replace database
        XxlJobGroup group = XxlJobGroupLocalCache.loadOne(jobInfo.getJobGroup());
        ...
        if (ExecutorRouteStrategyEnum.SHARDING_BROADCAST == ExecutorRouteStrategyEnum.match(
                jobInfo.getExecutorRouteStrategy(), null) && group.getRegistryList() != null && !group.getRegistryList()
                .isEmpty() && shardingParam == null) {
    ...
    private static void processTrigger(XxlJobGroup group, XxlJobInfo jobInfo, int finalFailRetryCount,
        ...
        triggerMsgSb.append(
                        "<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>" + I18nUtil.getString("jobconf_trigger_run")
                                + "<<<<<<<<<<< </span><br>")
