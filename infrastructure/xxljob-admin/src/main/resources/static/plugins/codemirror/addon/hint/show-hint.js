...
(function (mod) {
  ...
  function Widget(completion, data) {
    ...
    cm.on("scroll", this.onScroll = function () {
      ...
      var point = newTop - (window.pageYOffset || (document.documentElement
  ...
  Widget.prototype = {
    ...
    changeActive: function (i, avoidWrap) {
      ...
      CodeMirror.signal(this.data, "select", this.data.list[this.selectedHint],
          node);
    },

    screenAmount: function () {
      return Math.floor(
          this.hints.clientHeight / this.hints.firstChild.offsetHeight) || 1;
    }
  };
