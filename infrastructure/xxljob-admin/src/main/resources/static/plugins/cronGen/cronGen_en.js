(function ($) {
  ...
  $.fn.extend({
    cronGen: function (options) {
      ...
      $('<li/>').html(
          $('<a id="MinutesTab" href="#Minutes">Minute</a>')).appendTo(topMenu);
      $('<li/>').html($('<a id="HourlyTab" href="#Hourly">Hour</a>')).appendTo(
          topMenu);
      $('<li/>').html($('<a id="DailyTab" href="#Daily">Day</a>')).appendTo(
          topMenu);
      $('<li/>').html(
          $('<a id="MonthlyTab" href="#Monthly">Month</a>')).appendTo(topMenu);
      $('<li/>').html($('<a id="WeeklyTab" href="#Weekly">Week</a>')).appendTo(
          topMenu);
      $('<li/>').html($('<a id="YearlyTab" href="#Yearly">Year</a>')).appendTo(
          topMenu);
